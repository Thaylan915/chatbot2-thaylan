...
from Backend.app.api.views.chat import (
    ...
    ChatPerguntaView,
    ChatHistoricoView,
    ChatHistoricoPeriodoView,
    ChatConversasView,
    ConversasUsuarioView,
    MensagemFeedbackView,
...
urlpatterns = [
    ...
    # Chat
    path("chat/iniciar/",                                ChatIniciarView.as_view(),         name="chat_iniciar"),
    path("chat/pergunta/",                               ChatPerguntaView.as_view(),        name="chat_pergunta"),
